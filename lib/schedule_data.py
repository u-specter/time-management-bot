...
SCHEDULE_NORMAL = [
    ...
    {"time": "19:30", "icon": "✍️", "cat": "purple",  "text": "БЛОК: блог — сценарий (Пн/Ср) / LinkedIn пост (Пт) / проект"},
...
SCHEDULE_SATURDAY = [
    ...
    {"time": "10:00", "icon": "🚀", "cat": "purple",  "text": "Личный проект / Vibe-coding / Запись видео для блога"},
